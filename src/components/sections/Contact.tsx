    ...
    <section id="contact" className="section-padding bg-brand/5">
      <Container>
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-5xl md:text-7xl font-extrabold mb-8 text-gradient" style={{ fontFamily: "var(--font-display)", letterSpacing: "-0.03em" }}>
            Start a project<span className="text-brand">.</span>
          </h2>
          <p className="text-xl text-muted mb-12 max-w-2xl mx-auto leading-relaxed" style={{ fontFamily: "var(--font-sans)", fontWeight: 300 }}>
